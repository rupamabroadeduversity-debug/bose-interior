      ...
      <div className="section-shell">
        <div className="mb-14 max-w-3xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold text-[var(--color-brand-charcoal)] sm:text-5xl">
            Interior services structured around real rooms, real routines, and cleaner execution.
          </h2>
          <p className="mt-5 text-lg leading-8 text-[var(--color-brand-stone)]">
            The service architecture makes it easy to understand what Bose Interior handles, from modular kitchens and
            wardrobes to full residential layouts and commercial environments.
          </p>
        </div>
