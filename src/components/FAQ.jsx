      ...
      <div className="section-shell max-w-4xl">
        <div className="mb-14 text-center">
          ...
          <h2 className="mt-4 text-4xl font-semibold text-[var(--color-brand-charcoal)] sm:text-5xl">
            Clear answers for clients comparing scope, process, and fit.
          </h2>
        </div>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <span className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-[rgba(163,141,114,0.12)] text-[var(--color-brand-charcoal)]">
