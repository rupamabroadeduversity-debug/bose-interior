...
const Contact = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const message = [
      'Hello Bose Interior, I would like to book an interior consultation.',
      `Name: ${form.name || 'Not provided'}`,
      `Phone: ${form.phone || 'Not provided'}`,
      `Project Type: ${form.projectType}`,
      `Project Location: ${form.locality || 'Not provided'}`,
    ].join('\n');
    ...
    <section id="contact" className="py-20 sm:py-24">
      <div className="section-shell">
        <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr]">
          ...
          >
            <p className="section-kicker text-[var(--color-brand-cream-strong)]">Contact</p>
            <h2 className="mt-4 text-4xl font-semibold sm:text-5xl">Make the next step feel easy, polished, and immediate.</h2>
            <p className="mt-5 text-lg leading-8 text-white/76">
              The consultation flow is intentionally simple. Visitors can call, email, open WhatsApp, or send a quick
              project brief without getting trapped in unnecessary form friction.
            </p>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="text-sm font-semibold uppercase tracking-[0.2em] text-white/55">Email</div>
                  <a href={`mailto:${businessDetails.email}`} className="mt-1 block text-xl font-semibold text-white">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="text-sm font-semibold uppercase tracking-[0.2em] text-white/55">Availability</div>
          ...
          >
            <div className="luxury-card p-7 sm:p-8">
              <div className="mb-6 flex items-center justify-between gap-4">
                ...
                <div className="hidden h-12 w-12 items-center justify-center rounded-2xl bg-[rgba(163,141,114,0.12)] text-[var(--color-brand-gold)] sm:flex">
              ...
              <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block">
                  ...
                  >
                    ...
                    <option>Wardrobe / Furniture</option>
                    <option>Commercial Interior</option>
                    <option>2D / 3D Design Planning</option>
                  </select>
                </label>

                <label className="block">
                  <span className="mb-2 block text-sm font-semibold text-[var(--color-brand-stone)]">Project Locality</span>
                  <input
                    type="text"
                    name="locality"
                    value={form.locality}
                    onChange={handleChange}
                    className="w-full rounded-2xl border border-[rgba(107,75,53,0.12)] bg-white px-4 py-3 text-[var(--color-brand-charcoal)] outline-none transition focus:border-[var(--color-brand-gold)]"
                    placeholder="Uluberia / Howrah / Kolkata"
                  />
                </label>
              ...
              <div className="mt-4 text-sm leading-6 text-[var(--color-brand-stone)]">
                This opens a pre-filled WhatsApp message so the team receives the lead with context immediately.
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/60 shadow-[0_18px_60px_rgba(33,24,18,0.08)]">
              <iframe
                ...
                title="Bose Interior Uluberia Location"
                className="w-full"
              />
            </div>
          </motion.div>
