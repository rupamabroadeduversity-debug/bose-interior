import { Mail, PanelsTopLeft, Phone } from 'lucide-react';
    ...
    <footer className="bg-[var(--color-brand-charcoal)] py-16 text-white">
      <div className="section-shell">
        <div className="grid gap-10 border-b border-white/10 pb-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-heading text-3xl font-semibold">Bose Interior</div>
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-white/68">
              A premium, consultation-first homepage direction for Bose Interior with stronger project storytelling,
              cleaner trust architecture, and more intentional lead capture.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-white/76">
              ...
              <a href={`mailto:${businessDetails.email}`} className="flex items-center gap-3 hover:text-white">
                <Mail size={16} />
        ...
        <div className="flex flex-col gap-4 pt-8 text-sm text-white/48 sm:flex-row sm:items-center sm:justify-between">
          <p>&copy; {new Date().getFullYear()} Bose Interior concept mockup.</p>
          <p>This is a concept mockup created by Pantechsoft for demonstration purposes to showcase modern digital positioning for local independent advisors.</p>
        </div>
      </div>
    </footer>
  );
