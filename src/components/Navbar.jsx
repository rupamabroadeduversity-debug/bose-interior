  ...
  return (
    <nav
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#fbf7f2]/92 py-3 shadow-[0_14px_40px_rgba(29,24,20,0.08)] backdrop-blur-md'
          : 'bg-transparent py-5'
      }`}
    >
      <div className="section-shell">
        <div className="flex items-center justify-between gap-6">
          <a href="#top" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl text-white shadow-lg">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #1d1814, #7a6655)' }}
              >
                <PanelsTopLeft size={20} />
              </div>
            </div>
            <div className="leading-tight">
              <span className="block font-heading text-2xl font-semibold text-[var(--color-brand-charcoal)]">
                Bose <span className="text-[var(--color-brand-gold)]">Interior</span>
              </span>
          ...
          <button
            ...
            className="rounded-full border border-[rgba(107,75,53,0.12)] bg-white/70 p-2.5 text-[var(--color-brand-charcoal)] lg:hidden"
